const preguntas = [
  {
    pregunta: "¿Cuál es la consecuencia principal de no implementar un plan de seguridad durante el desarrollo de un software?",
    opciones: {
      A: "Aumento automático de la velocidad del software",
      B: "Exposición a vulnerabilidades y posibles incidentes de seguridad",
      C: "Eliminación de la necesidad de mantenimiento",
      D: "Mejora inmediata en la experiencia del usuario"
    },
    correcta: "B"
  },
  {
    pregunta: "¿Qué tipo de riesgo se presenta cuando una vulnerabilidad del software permite la fuga de información personal o clasificada?",
    opciones: {
      A: "Riesgo estético",
      B: "Riesgo de rendimiento",
      C: "Riesgo de seguridad y privacidad",
      D: "Riesgo de compatibilidad"
    },
    correcta: "C"
  },
  {
    pregunta: "Según la información del módulo, uno de los impactos de una brecha de seguridad es:",
    opciones: {
      A: "Mejora de la reputación de la empresa",
      B: "Aceleración del proceso de desarrollo",
      C: "Afectación en la relación con clientes y stakeholders",
      D: "Reducción de costos operativos"
    },
    correcta: "C"
  },
  {
    pregunta: "¿Cuál es el objetivo principal de la norma ISO 27001?",
    opciones: {
      A: "Establecer estándares de diseño gráfico",
      B: "Definir los requisitos para un Sistema de Gestión de Seguridad de la Información",
      C: "Regular la calidad visual de la interfaz de usuario",
      D: "Determinar licencias de software libre"
    },
    correcta: "B"
  },
  {
...
function mostrar_resultados() 
{
  ...
  if (aprobo) {
    ...
    footerHtml = `
      <button class="botones_footer" onclick="location.href='pagina_8.html'">Reintentar</button>
    `;
  }
